...
import dev.thomazz.pledge.sponge.api.event.ActivateHandlerEvent;
...
public class PacketFrameOutboundHeadHandler extends ChannelOutboundHandlerAdapter {
	...
	public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
		...
		if (this.pledge.getPacketProvider().isLogin(msg)) {
			...
			Sponge.eventManager().post(new ActivateHandlerEvent(this.playerHandler.getPlayer(), ctx.channel()));
