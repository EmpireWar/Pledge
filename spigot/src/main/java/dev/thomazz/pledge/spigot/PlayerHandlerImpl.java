...
import dev.thomazz.pledge.spigot.api.event.ConnectionValidateEvent;
import dev.thomazz.pledge.spigot.api.event.PacketFrameCreateEvent;
import dev.thomazz.pledge.spigot.api.event.PacketFrameErrorEvent;
import dev.thomazz.pledge.spigot.api.event.PacketFrameReceiveEvent;
import dev.thomazz.pledge.spigot.api.event.PacketFrameTimeoutEvent;
import dev.thomazz.pledge.spigot.network.PacketFrameOutboundHeadHandler;
...
import dev.thomazz.pledge.spigot.network.PacketFrameOutboundTailHandler;
...
public class PlayerHandlerImpl implements PlayerHandler {
    ...
    public PlayerHandlerImpl(PledgeSpigot pledge, Player player, Channel channel) {
        this.pledge = pledge;
        this.player = player;
